  ...
  <div class="light-bg">
    ...
    <div class="shell">
      ...
      <div class="header">
        ...
        <nav id="navigation">
          <ul>
            <li class="first"><a href="#">SHOW ALL</a></li>
            <li><a href="#">LATEST MOVIES <span>20</span></a></li>
            <li><a href="#">TOP RATED</a></li>
            <li class="last"><a href="#">MOST COMMENTED</a></li>
          </ul>
        </nav>
        <!-- end of navigation -->
        <div class="cl">&nbsp;</div>
      ...
      <div class="main">
        ...
        <section class="content">
          ...
          <div class="post">
            ...
            <div class="post-inner">
              ...
              <div class="img-holder"> <a href="#"><img src="css/images/post-img.jpg" alt=""></a> <a href="css/images/post-img.jpg" class="btn-full-image popup cboxElement"><span>FULL IMAGE</span></a> </div>
              <!-- meta -->
              <div class="meta">
          ...
          <div class="post">
            ...
            <div class="post-inner">
              ...
              <div class="img-holder"> <a href="#"><img src="css/images/post-img2.jpg" alt=""></a> <a href="css/images/post-img2.jpg" class="btn-full-image popup cboxElement"><span>FULL IMAGE</span></a> </div>
              <!-- meta -->
              <div class="meta">
                <p class="date">APRIL 09, 2012 by <a href="#">JOHN DOE</a></p>
                <div class="right">
          ...
          <div class="post">
            ...
            <div class="post-inner">
              ...
              <div class="img-holder"> <a href="#"><img src="css/images/post-img3.jpg" alt=""></a> <a href="css/images/post-img3.jpg" class="btn-full-image popup cboxElement"><span>FULL IMAGE</span></a> </div>
              <!-- meta -->
              <div class="meta">
                <p class="date">APRIL 09, 2012 by <a href="#">JOHN DOE</a></p>
                <div class="right">
        ...
        <aside class="sidebar">
          <div class="widget">
            ...
            <ul>
              <li class="first"><a href="#">Action</a></li>
          ...
          <div class="widget">
            ...
            <ul>
              <li class="first"><a href="#">The Hunter Games <strong>$98 Mil</strong></a></li>
          ...
          <div class="widget socials-widget">
            ...
            <ul>
              <li class="first"><a href="#" class="facebook-ico"><span></span>Facebook</a></li>
      ...
      <div class="footer">
        ...
        <p class="copy">Copyright © 2012 <span>|</span> Sitename. Design by <a target="_blank" href="http://chocotemplates.com">ChocoTemplates</a></p>
      </div>
    </div>
    <!-- end of shell -->
  </div>
